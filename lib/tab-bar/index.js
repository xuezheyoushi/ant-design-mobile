    ...
    function AntTabBar() {
        ...
        _this2.renderTabBar = function () {
            var _this2$props = _this2.props,
                ...
                backgroundTintColor = _this2$props.backgroundTintColor,
                unselectedBackgroundTintColor = _this2$props.unselectedBackgroundTintColor,
            ...
            var content = Array.isArray(tabsData) ? tabsData.map(function (cProps, index) {
                return _react2['default'].createElement(_Tab2['default'], { key: index, prefixCls: _this2.props.prefixCls + '-tab', badge: cProps.badge, dot: cProps.dot, selected: cProps.selected, icon: cProps.icon, selectedIcon: cProps.selectedIcon, title: cProps.title, tintColor: tintColor, unselectedTintColor: unselectedTintColor, backgroundTintColor: backgroundTintColor, unselectedBackgroundTintColor: unselectedBackgroundTintColor, dataAttrs: (0, _getDataAttr2['default'])(cProps), onClick: function onClick() {
