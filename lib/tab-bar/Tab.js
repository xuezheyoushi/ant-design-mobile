    ...
    (0, _createClass3['default'])(Tab, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                unselectedBackgroundTintColor = _props.unselectedBackgroundTintColor,
                backgroundTintColor = _props.backgroundTintColor;

            var iconColor = selected ? tintColor : unselectedTintColor;
            var backgroundColor = selected ? unselectedBackgroundTintColor : backgroundTintColor;
            return _react2['default'].createElement(
                'div',
                (0, _extends3['default'])({}, this.props.dataAttrs, { onClick: this.onClick, className: '' + prefixCls, style: { backgroundColor: backgroundColor } }),
